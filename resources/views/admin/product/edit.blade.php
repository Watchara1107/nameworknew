          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">หน้า Add Product</h1>
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">หน้า Edit Product</li>
              </ol>
          </div>
          <div class="row">
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">หน้า Edit Product</h6>
                  ...
                  <form action="{{url('/admin/product/update/'.$editproduct->id_product)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="image" name="image" value="{{$editproduct->image}}">
                    ...
                    <div class="mt-4">
                      <img id="showImage" src="{{asset('admin/img/'.$editproduct->image)}}" width="105px" alt="">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="category_id">
                        <!-- <option selected="selected" value="{{$editproduct->catefgory_id}}">{{$editproduct->category->name}}</option> -->
